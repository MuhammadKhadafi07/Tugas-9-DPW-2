...
<div class="sales">
    <div class="container">
	  <div class="header_top">
						...
						<ul class="sub-icon1 list">
						  ...
						  <div class="shopping_cart">
							  <div class="cart_box">
					                ...
					                <div class="list_img"><img src="{{url('public')}}/images/1.jpg" class="img-responsive" alt=""/></div>
	                            ...
	                            <div class="cart_box1">
								  <div class="message2">
					                ...
					                <div class="list_img"><img src="{{url('public')}}/images/3.jpg" class="img-responsive" alt=""/></div>
								    <div class="list_desc"><h4><a href="#">velit esse molestie</a></h4>1 x<span class="actual">
		                             $12.00</span></div>
		                              <div class="clearfix"></div>
	                              </div>
		...
		<div class="menu">																
			<a href="#" class="right_bt" id="activator"><img src="{{url('public')}}/images/menu.png" alt=""/></a>
  ...
  <div class="container">
		...
		<div class="col-md-9 content_right">
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="{{url('public')}}/images/s11.jpg" class="img-responsive" />
									<img class="etalage_source_image" src="{{url('public')}}/images/s13.jpg" class="img-responsive" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{url('public')}}/images/s12.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="{{url('public')}}/images/s12.jpg" class="img-responsive" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{url('public')}}/images/s13.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="{{url('public')}}/images/s13.jpg" class="img-responsive" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{url('public')}}/images/s11.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="{{url('public')}}/images/s11.jpg" class="img-responsive" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{url('public')}}/images/s12.jpg" class="img-responsive" />
								<img class="etalage_source_image" src="{{url('public')}}/images/s12.jpg" class="img-responsive" />
		   ...
		   <div class="sap_tabs">	
				     ...
				     <ul id="flexiselDemo3">
						<li><img src="{{url('public')}}/images/pic3.jpg" class="img-responsive"/><div class="grid-flex"><a href="#">Syenergy 2mm</a><p>Rs 850</p></div></li>
						<li><img src="{{url('public')}}/images/pic4.jpg" class="img-responsive"/><div class="grid-flex"><a href="#">Surf Yoke</a><p>Rs 1050</p></div></li>
						<li><img src="{{url('public')}}/images/pic5.jpg" class="img-responsive"/><div class="grid-flex"><a href="#">Salty Daiz</a><p>Rs 990</p></div></li>
						<li><img src="{{url('public')}}/images/pic3.jpg" class="img-responsive"/><div class="grid-flex"><a href="#">Cheeky Zane</a><p>Rs 850</p></div></li>
						<li><img src="{{url('public')}}/images/pic4.jpg" class="img-responsive"/><div class="grid-flex"><a href="#">Synergy</a><p>Rs 870</p></div></li>
				     </ul>
				    <script type="text/javascript">
				   ...
				   <ul id="flexiselDemo1">
						<li><img src="{{url('public')}}/images/pic6.jpg" class="img-responsive"/><div class="grid-flex"><a href="#">Syenergy 2mm</a><p>Rs 850</p></div></li>
						<li><img src="{{url('public')}}/images/pic7.jpg" class="img-responsive"/><div class="grid-flex"><a href="#">Surf Yoke</a><p>Rs 1050</p></div></li>
						<li><img src="{{url('public')}}/images/pic8.jpg" class="img-responsive"/><div class="grid-flex"><a href="#">Salty Daiz</a><p>Rs 990</p></div></li>
						<li><img src="{{url('public')}}/images/pic6.jpg" class="img-responsive"/><div class="grid-flex"><a href="#">Cheeky Zane</a><p>Rs 850</p></div></li>
						<li><img src="{{url('public')}}/images/pic7.jpg" class="img-responsive"/><div class="grid-flex"><a href="#">Synergy</a><p>Rs 870</p></div></li>
				     </ul>
				    <script type="text/javascript">
					 $(window).load(function() {
...
<div class="footer">
	<div class="container">
		<img src="{{url('public')}}/images/f_logo.png" alt=""/>
		<p><a href="https://www.instagram.com/dafiscode/">info(at)Khadafi.com</a></p>
		<div class="copy">
			<p>© 2021 Tugas-2-DPW-2 by <a href="https://www.instagram.com/dafiscode/">Muhammad Khadafi</a> </p>
		</div>
		<ul class="social">
